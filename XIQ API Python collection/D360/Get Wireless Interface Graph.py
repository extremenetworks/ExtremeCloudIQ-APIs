...
url = f"https://api.extremecloudiq.com/d360/wireless/interfaces-graph"
headers = {'Authorization': f'Bearer {access_token}'}
params = {'deviceId': f'{device_id}', 'startTime': f'{myStartTime}', 'endTime': f'{myEndTime}', 'channel': 'WIFI0'}

# source: CHANNEL_UTILIZATION (disabled)
