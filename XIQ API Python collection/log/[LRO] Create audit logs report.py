...
url = f"https://api.extremecloudiq.com/logs/audit/reports"
headers = {'Authorization': f'Bearer {access_token}'}
params = {'startTime': f'{myStartTime}', 'endTime': f'{myEndTime}', 'timeZoneOffset': '0'}

# sortField: TIMESTAMP (disabled)
# sortOrder: ASC (disabled)
# category: ADMIN (disabled)
