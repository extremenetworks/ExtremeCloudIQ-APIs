...
alert_group = "SEVERITY" #Available values : SEVERITY, CATEGORY, ALERT_TYPE
myStartTime = utc_seconds("2022-12-2 02:30:00", 'US/Eastern')
myEndTime = utc_seconds("2023-2-23 02:30:00", 'US/Eastern')
access_token = '***'

url = f"https://api.extremecloudiq.com/alerts/count-by-{alert_group}?startTime={myStartTime}&endTime={myEndTime}"
