...
url = f"https://api.extremecloudiq.com/copilot/connectivity/wired/quality-index"
headers = {'Authorization': f'Bearer {access_token}'}
params = {'viewType': 'LOCATION', 'startTime': f'{myStartTime}', 'endTime': f'{myEndTime}', 'forensicBucket': 'TWENTY_FOUR_HOURS'}

# viewId: None (disabled)
