...
url = f"https://api.extremecloudiq.com/copilot/connectivity/wired/quality-index?viewType=LOCATION&startTime={myStartTime}&endTime={myEndTime}&forensicBucket=TWENTY_FOUR_HOURS"
