...
url = f"https://api.extremecloudiq.com/copilot/connectivity/wired/experience"
headers = {'Authorization': f'Bearer {access_token}'}
params = {'viewType': 'LOCATION', 'startTime': f'{myStartTime}', 'endTime': f'{myEndTime}', 'page': '1', 'limit': '10'}
