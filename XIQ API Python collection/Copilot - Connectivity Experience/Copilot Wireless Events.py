...
url = f"https://api.extremecloudiq.com/copilot/connectivity/wireless/events?viewType=LOCATION&startTime={myStartTime}&endTime={myEndTime}&page=1&limit=10&scoreType=TIME_TO_AUTHENTICATE"
