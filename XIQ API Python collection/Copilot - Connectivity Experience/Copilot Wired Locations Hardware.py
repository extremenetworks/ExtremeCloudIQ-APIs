...
url = f"https://api.extremecloudiq.com/copilot/connectivity/wired/locations/hardware"
headers = {'Authorization': f'Bearer {access_token}'}
params = {'startTime': f'{myStartTime}', 'endTime': f'{myEndTime}', 'forensicBucket': 'TWENTY_FOUR_HOURS'}

# viewType: LOCATION (disabled)
# viewId:  (disabled)
