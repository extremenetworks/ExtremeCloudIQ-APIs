...
url = f"https://api.extremecloudiq.com/copilot/connectivity/wired/hardware?viewType=LOCATION&startTime={myStartTime}&endTime={myEndTime}&forensicBucket=TWENTY_FOUR_HOURS"
