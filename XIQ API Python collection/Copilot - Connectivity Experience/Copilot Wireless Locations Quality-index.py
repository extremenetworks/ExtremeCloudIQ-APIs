...
url = f"https://api.extremecloudiq.com/copilot/connectivity/wireless/locations/quality-index?buildingId={building_id}&startTime={myStartTime}&endTime={myEndTime}"
