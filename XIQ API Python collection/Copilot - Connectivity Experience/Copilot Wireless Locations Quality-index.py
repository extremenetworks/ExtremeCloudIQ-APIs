...
url = f"https://api.extremecloudiq.com/copilot/connectivity/wireless/locations/quality-index?locationId={location_id}&startTime={myStartTime}&endTime={myEndTime}"
