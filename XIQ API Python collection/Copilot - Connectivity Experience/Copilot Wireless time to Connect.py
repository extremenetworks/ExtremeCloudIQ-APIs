...
url = f"https://api.extremecloudiq.com/copilot/connectivity/wireless/time-to-connect?viewType=LOCATION&startTime={myStartTime}&endTime={myEndTime}&viewId={view_id}&forensicBucket=TWENTY_FOUR_HOURS"
