...
url = f"https://api.extremecloudiq.com/copilot/connectivity/wireless/experience"
headers = {'Authorization': f'Bearer {access_token}'}
params = {'viewType': 'LOCATION', 'page': '1', 'limit': '10', 'startTime': f'{myStartTime}', 'endTime': f'{myEndTime}'}
