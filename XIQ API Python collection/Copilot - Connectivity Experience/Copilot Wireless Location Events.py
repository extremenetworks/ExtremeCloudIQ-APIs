...
url = f"https://api.extremecloudiq.com/copilot/connectivity/wireless/locations/events?page=1&limit=10&startTime={myStartTime}&endTime={myEndTime}&scoreType=TIME_TO_AUTHENTICATE&locationId={location_id}"
